		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="<%=url %>/product/Ác Quỷ Nam Kinh.jsp"><img class="card-img-top"
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="<%=url %>/product/Ring - Vòng Tròn Ác Nghiệt.jsp"><img
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="<%=url %>/product/GOTH - Những Kẻ Hắc Ám.jsp"><img class="card-img-top"
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="<%=url %>/product/Bạch Dạ Hành.jsp"><img
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="<%=url%>/product/Mùi Hương.jsp"><img class="card-img-top"
