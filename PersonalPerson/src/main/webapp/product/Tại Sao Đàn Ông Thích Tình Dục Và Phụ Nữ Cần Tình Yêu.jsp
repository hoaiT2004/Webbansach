...
<head>
<meta charset="UTF-8">
<title>Sách Tại Sao Đàn Ông Thích Tình Dục Và Phụ Nữ Cần Tình Yêu</title>
</head>
<link
...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/taisaodanongbook.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/taisao1.png" alt="2">
						</div>
					</div>
			...
			Book Java = dao.searchName("Tại Sao Đàn Ông Thích Tình Dục Và Phụ Nữ Cần Tình Yêu");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Tại Sao Đàn Ông Thích Tình Dục Và Phụ Nữ Cần Tình Yêu</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Tại Sao Đàn Ông Thích Tình Dục Và Phụ Nữ Cần Tình Yêu"> 
					<input type="hidden" name = "tenlink" value="taisaodanong">
