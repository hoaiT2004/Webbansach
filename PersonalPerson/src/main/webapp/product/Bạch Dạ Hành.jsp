...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/bachdahanhbook.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/bachdahanh1.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/bachdahanh2.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("Bạch Dạ Hành");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Bạch Dạ Hành - Sách kinh dị</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Bạch Dạ Hành"> 
				<input type="hidden" name = "tenlink" value="bachdahanh">
