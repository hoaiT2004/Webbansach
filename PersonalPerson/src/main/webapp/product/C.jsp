...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/Cbook.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/C1.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/c2.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("C");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">C/C++ - Ngôn ngữ lập trình - Ngôn
					ngữ dễ tiếp cận</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="C"> 
				<input type="hidden" name = "tenlink" value="C"> 
