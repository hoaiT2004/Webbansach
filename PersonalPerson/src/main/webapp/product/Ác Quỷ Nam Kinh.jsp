...
<head>
<meta charset="UTF-8">
<title>Sách Ác Quỷ Nam Kinh</title>
</head>
<link
...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/acquy1.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/acquy2.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/acquybook.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("Ác Quỷ Nam Kinh");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Ác Quỷ Nam Kinh - Sách kinh dị</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Ác Quỷ Nam Kinh"> 
					<input type="hidden" name = "tenlink" value="acquynamkinh"> 
