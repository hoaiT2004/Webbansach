...
<head>
<meta charset="UTF-8">
<title>Sách GOTH – Những Kẻ Hắc Ám</title>
</head>
<link
...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/goth1.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/goth2.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/gothbook.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("GOTH - Những Kẻ Hắc Ám");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">GOTH – Những Kẻ Hắc Ám</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="GOTH - Những Kẻ Hắc Ám"> 
				<input type="hidden" name = "tenlink" value="goth"> 
