...
<head>
<meta charset="UTF-8">
<title>Sách Tâm Lý Học Và Chuyện Yêu: Vì Sao Đàn Ông Thích Phụ Nữ Trẻ, Phụ Nữ Thích Đàn Ông Giàu?</title>
</head>
<link
...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/tamlyhocvachuyenyeubook.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/visaodanong1.png" alt="2">
						</div>
					</div>
			...
			Book Java = dao.searchName("Tâm Lý Học Và Chuyện Yêu: Vì Sao Đàn Ông Thích Phụ Nữ Trẻ, Phụ Nữ Thích Đàn Ông Giàu?");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Tâm Lý Học Và Chuyện Yêu: Vì Sao Đàn Ông Thích Phụ Nữ Trẻ, Phụ Nữ Thích Đàn Ông Giàu?</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Tâm Lý Học Và Chuyện Yêu: Vì Sao Đàn Ông Thích Phụ Nữ Trẻ, Phụ Nữ Thích Đàn Ông Giàu?"> 
					<input type="hidden" name = "tenlink" value="tamlyhocvachuyenyeu">
					<h6 style="text-align: right;">
						Đã bán
						<%=100000 - Java.getCount_()%>
						sản phẩm
					</h6>
					<div class="row">
						<div class="col-lg-4">
