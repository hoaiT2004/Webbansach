...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/trahoanubook.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/trahoanu1.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/trahoanu2.png" alt="3">
						</div>
					</div>
			...
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Trà Hoa Nữ - Sách ngôn tình</h1>
				<hr>
				...
				<input type="hidden" name = "hd" value="check">
					<input type="hidden" name = "tensach" value="Trà Hoa Nữ">
					<input type="hidden" name = "tenlink" value="trahoanu">
