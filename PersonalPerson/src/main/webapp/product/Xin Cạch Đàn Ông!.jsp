...
<head>
<meta charset="UTF-8">
<title>Sách Xin Cạch Đàn Ông!</title>
</head>
<link
...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/xincachdanongbook.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/xincachdanong1.png" alt="2">
						</div>
					</div>
			...
			Book Java = dao.searchName("Xin Cạch Đàn Ông!");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Xin Cạch Đàn Ông! - Sách ngôn tình</h1>
				<hr>
				...
				<h4 style="text-align: center;color:red;"><%=baoLoi %></h4>
					<input type="hidden" name = "tensach" value="Xin Cạch Đàn Ông!">
					<input type="hidden" name = "tenlink" value="xincachdanong">
