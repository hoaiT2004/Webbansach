...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/go1.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/go2.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/golangbook.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("Golang");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Golang - Ngôn ngữ cổ nhưng không cũ</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Golang"> 
					<input type="hidden" name = "tenlink" value="Golang"> 
