...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/Py1.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/py2.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/pythonbook.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("Python");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Python - Điện toán đám mây</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Python"> 
					<input type="hidden" name = "tenlink" value="Python"> 
