...
<head>
<meta charset="UTF-8">
<title>Sách Ring – Vòng Tròn Ác Nghiệt</title>
</head>
<link
...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/ring1.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/ring2.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/vongtronacnghietbook.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("Ring - Vòng Tròn Ác Nghiệt");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Ring – Vòng Tròn Ác Nghiệt</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Ring – Vòng Tròn Ác Nghiệt"> 
							<input type="hidden" name = "tenlink" value="ring"> 
