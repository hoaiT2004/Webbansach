...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/java.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/java2.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/java3.png" alt="3">
						</div>
					</div>
			...
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Java - Ngôn ngữ lập trình - Ngôn
					ngữ bậc cao</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Java"> 
				<input type="hidden" name = "tenlink" value="Java"> 
