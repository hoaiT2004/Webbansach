...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/JS1.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/jsbook.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/JS2.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("JS");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">JavaScript - Ngôn ngữ lập trình - Ngôn
					ngữ đa năng</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="JS"> 
				<input type="hidden" name = "tenlink" value="JS">
