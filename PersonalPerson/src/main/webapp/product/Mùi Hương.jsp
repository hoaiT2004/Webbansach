...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/muihuongbook.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/muihuong1.png" alt="2">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/muihuong2.png" alt="3">
						</div>
					</div>
			...
			Book Java = dao.searchName("Mùi Hương");
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">Mùi Hương - Sách kinh dị</h1>
				<hr>
				...
				<input type="hidden" name = "tensach" value="Mùi Hương">
					<input type="hidden" name = "tenlink" value="muihuong">  
