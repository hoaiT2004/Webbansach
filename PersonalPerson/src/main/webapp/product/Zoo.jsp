...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/ZOObook.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/zoo1.png" alt="2">
						</div>
					</div>
			...
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">ZOO - Sách kinh dị</h1>
				<hr>
				...
				<input type="hidden" name = "hd" value="check">
					<input type="hidden" name = "tensach" value="Zoo">
						<input type="hidden" name = "tenlink" value="Zoo">
