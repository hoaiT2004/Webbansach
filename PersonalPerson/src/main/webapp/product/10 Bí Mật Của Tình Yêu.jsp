...
<head>
<meta charset="UTF-8">
<title>Sách 10 Bí Mật Của Tình Yêu</title>
</head>
<link
...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide mb-4"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="<%=url %>/img/10bimattinhyeu.png" alt="1">
						</div>
						<div class="carousel-item">
							<img src="<%=url %>/img/10 bi mat ty1.png" alt="2">
						</div>
					</div>
			...
			Book Java = dao.searchName("10 Bí Mật Của Tình Yêu");
			String baoLoi = request.getAttribute("baoLoiSL")+"";
			int money = (int) Java.getPrice();
			%>
			<div class="col-lg-8">
				<h1 style="text-align: center">10 Bí Mật Của Tình Yêu</h1>
				<hr>
				<%
				baoLoi = (baoLoi.equals("null"))?"":baoLoi;
				%>
				<h4 style="text-align: center;color:red;"><%=baoLoi %></h4>
				<form action="<%=url%>/dat-hang-controller" class="form"
					method="get">
					<input type="hidden" name = "hd" value="check">
					<input type="hidden" name="tensach" value="10 Bí Mật Của Tình Yêu">
					<input type="hidden" name="tenlink" value="10bimat">
					...
					<div class="discount-info">
						<div>
							<h2 style="color: gray;">THÔNG TIN & KHUYẾN MÃI</h2>
						</div>
						<div class="content">
							<p>
