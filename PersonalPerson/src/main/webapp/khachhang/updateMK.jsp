...
<script type="text/javascript">
	   function myFunction() {
		      return "Đã xác thực thành công!!! Vui lòng đổi mật khẩu";
		    }
	...
	<div class="main__user">
		...
		<div class="setting__main">
			<form action="<%=url %>/khach-hang-controller" method="post" class="form">
				<input type="hidden" name="hanhdong" value ="doi-mk-moilaylai">
				...
				<div>
					...
					<h1 class="setting__main__pw__title" style="text-align: center">Đổi
						mật khẩu</h1>
						<h3 style="text-align: center;color: red;"><%=baoLoiMK %></h3>
					...
					<div>
						<label>Nhập lại mật khẩu<span style="color: red">*</span><span
							style="color: red" id="baoloi"></span></label>
