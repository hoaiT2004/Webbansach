...
<body class="text-center">
	...
	<main class="form-signin w-100 m-auto">
		...
		<input type="hidden" name="tenlink" value ="<%=tenLink%>">
			<img class="mb-4" src="<%=url%>/img/logo/logo.png" alt="" width="72">
			<h1 class="h3 mb-3 fw-normal">ĐĂNG NHẬP</h1>
			<%
			String baoLoi = request.getAttribute("baoLoiDN") + "";
			...
			<div class="form-floating">
				<input type="text" class="form-control" id="tenDangNhap"
					placeholder="Tên đăng nhập" required="required" name="tenDangNhap"
					value=<%=tenDangNhap%>> <label for="tenDangNhap">Tên
					đăng nhập</label>
			</div>
			<div class="form-floating">
				<input type="password" class="form-control" id="matKhau"
					placeholder="Mật khẩu" name="matKhau" required="required"> <label for="matKhau">Mật
					khẩu</label>
			</div>
			...
			<button class="w-50 btn btn-lg btn-primary" type="submit">Đăng
				nhập</button> 
				<br>
				<a href="<%=url %>/khachhang/layLaiMK.jsp">Quên mật khẩu</a>
			<hr>	
			<a type="submit" class="btn btn-primary" style="background-color: green;" href="<%=url %>/khachhang/dangKy.jsp">Tạo tài khoản mới</a>
